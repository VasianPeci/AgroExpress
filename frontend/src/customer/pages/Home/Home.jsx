        ...
        <div className="space-y-2 lg:space-y-2 relative">
          ...
          {homePage.homePageData?.deals && (
            <section className="pt-01">
              <h1 className="text-center text-lg lg:text-4xl font-bold text-[#4CAF50] pb-1 pt-1 lg:pb-1">
                Today's Deals
              </h1>
              <DealSlider />
            </section>
          ...
          {homePage.homePageData?.shopByCategories && (
            <section className="flex flex-col justify-center items-center py-0 px-5 lg:px-20">
              <h1 className="text-lg lg:text-4xl font-bold agricultural-header pb-5 lg:pb-10">
                SHOP BY CATEGORY
              </h1>
              <HomeCategory />
            </section>
          ...
          <section className="lg:px-10 relative h-[200px] lg:h-[450px] object-cover">
            ...
            <div className="absolute top-1/2 left-4 lg:left-[15rem] transform  -translate-y-1/2 font-semibold lg:text-4xl space-y-3 ">
              ...
              <p className="text-lg md:text-2xl">
                With{" "}
                <strong className="text-3xl font-bold transition-all duration-300 magical-logo-text">
                  AgroExpress
                </strong>
              </p>
