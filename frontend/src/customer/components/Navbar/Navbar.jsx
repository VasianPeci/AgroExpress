...
const MagicalLogo = ({ onClick, className }) => {
  ...
  useEffect(() => {
    ...
    const createSparkle = () => {
      ...
      const randomClass =
        sparkleClasses[Math.floor(Math.random() * sparkleClasses.length)];
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold transition-all duration-300 magical-logo-text">
        AgroExpress
      </h1>
...
const Navbar = () => {
  ...
  return (
    <Box
      sx={{ zIndex: 2 }}
      className="sticky top-0 left-0 right-0 bg-white blur-bg bg-opacity-80 magical-navbar"
    >
